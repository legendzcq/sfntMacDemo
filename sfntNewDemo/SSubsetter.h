...
// Subsets a given font using a character predicate.
    class SSubsetter : public sfntly::RefCounted<SSubsetter> {
 public:
  SSubsetter(sfntly::Font* font, CharacterPredicate* predicate);
  SSubsetter(const char* font_path, CharacterPredicate* predicate);
  virtual ~SSubsetter() { }
